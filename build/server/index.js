...
const SearchLayout = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: `px-[15px] `, children: /* @__PURE__ */ jsx("div", { className: `max-w-[1100px] w-full mx-auto bg-white`, children: /* @__PURE__ */ jsxs("div", { className: `grid grid-cols-12 mt-5 gap-6 relative`, children: [
...
const index$e = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    data.query.length > 0 ? /* @__PURE__ */ jsx("div", { className: ` flex mt-4 px-[15px] 
                border-b pb-2 tracking-tight`, children: /* @__PURE__ */ jsxs("div", { className: `max-w-[1100px] w-full mx-auto
                            text-[24px]`, children: [
      "Search for ",
      /* @__PURE__ */ jsx("b", { children: data.query })
    ] }) }) : /* @__PURE__ */ jsx("div", { className: ` flex mt-4 px-[15px] 
                border-b pb-2 tracking-tight`, children: /* @__PURE__ */ jsx("div", { className: `max-w-[1100px] w-full mx-auto
                            text-[24px]`, children: "Latest businesses" }) }),
    /* @__PURE__ */ jsxs(SearchLayout, { children: [
      data.datar.length > 0 ? /* @__PURE__ */ jsx(
        SearchPagination,
        {
          data: data.datar,
          itemsPerPage: 20,
          renderItem: (item) => {
            return /* @__PURE__ */ jsx(ResultCard, { listing: item }, index$e);
                            ...
                            place-content-center p-8 border capitalize`, children: /* @__PURE__ */ jsx("span", { children: "no record" }) }),
      /* @__PURE__ */ jsx(
        LatestBusinesses,
        {
